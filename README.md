...
* [CDRipRename - renames CD RIP fnames to longer names based on trackname file](#cdriprename-\--renames-cd-rip-fnames-to-longer-names-based-on-trackname-file "CDRipRename - renames CD RIP fnames to longer names based on trackname file")
